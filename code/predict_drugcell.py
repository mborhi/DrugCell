...
def predict_dcell(predict_data, gene_dim, model_file, hidden_folder, batch_size, result_file, cell_features):
...
predict_data, cell2id_mapping = prepare_predict_data(opt.predict, opt.cell2id)
...
predict_dcell(predict_data, num_genes, opt.load, opt.hidden, opt.batchsize, opt.result, cell_features)	
