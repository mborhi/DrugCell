...
mutationfile=$inputdir"reactome-sample2binary_mutation.txt" #"sample2binary_mutation.txt" #"cell2mutation.txt"
...
python -u ../code/train_drugcell.py -onto $ontfile -gene2id $gene2idfile -cell2id $cell2idfile -train $traindatafile -test $valdatafile -model $modeldir -cuda $cudaid -genotype $mutationfile -genotype_hiddens 6 -final_hiddens 2 -epoch 1 -batchsize 10 > train_script.log
